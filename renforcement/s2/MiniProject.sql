...
INSERT INTO type_chambres (nom,prix,capacite) VALUES
('Single',300,1),
('Double',500,2),
('Suite',900,4),
('Deluxe',1200,5);

INSERT INTO chambres (numero, etage, statut, type_id) VALUES
('101',1,'disponible',1),
('102',1,'disponible',1),
('103',1,'occupée',1),
('104',1,'disponible',1),
...
(1, 1, '2026-05-01', '2026-05-05', 'confirmée'),
...
INSERT INTO factures (reservation_id, montant, date_paiement) VALUES
(1, 1200, '2026-05-01'),
(2, 1500, '2026-05-03'),
(4, 3000, '2026-05-10'),
(5, 4200, '2026-05-12'),
...
COUNT(DISTINCT c.id) AS total_chamrbes,
(COUNT(r.id) * 100.0 / COUNT(DISTINCT c.id)) AS taux
FROM type_chambres t 
JOIN chambres c ON c.type_id = t.id
